    ...
    public class ConfigureServices : BaseOptimization
    {
        public override Task<ApplyResult> ApplyAsync(IProgress<ProcessingProgress> progress, OptimizationContext context)
        {
            var servicesToChange = new List<ServiceItem>
            {
                ...
                new("LanmanServer", ServiceStartupType.Automatic),
                ...
                new("RetailDemo", ServiceStartupType.Manual),
                ...
                new("Spooler", ServiceStartupType.Automatic),
                ...
                new("TermService", ServiceStartupType.Automatic),
                ...
                new("VGAuthService", ServiceStartupType.Automatic),
                new("VMTools", ServiceStartupType.Automatic),
                ...
                new("WSearch", ServiceStartupType.AutomaticDelayedStart),
                ...
                new("gpsvc", ServiceStartupType.Automatic),
