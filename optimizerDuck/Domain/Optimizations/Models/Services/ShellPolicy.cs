...
{
    /// <summary>
    ///     Default policy: exit code 0 is success; error text comes from stderr or the exit code.
    /// </summary>
    ...
    /// <summary>
    ///     Creates a policy with a custom success function and optional error factory.
    /// </summary>
    /// <param name="isSuccess">Determines whether a result is successful.</param>
    /// <param name="errorFactory">
    ///     Produces an error message from a failed result; null uses the default factory.
    /// </param>
    ...
    /// <summary>
    ///     Creates a policy that treats exit codes from 0 to <paramref name="maxOk" /> as success.
    /// </summary>
