...
/// </summary>
/// <remarks>
///     When one ViewModel modifies data that another page displays, call
///     <see cref="NotifyDataChanged{T}"/> with the appropriate event type.
///     The target ViewModel checks for pending changes in
...
///         All type safety is enforced at compile time via the
///         <see cref="ICrossPageEvent"/> constraint.
///     </para>
/// </remarks>
