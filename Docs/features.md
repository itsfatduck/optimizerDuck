...
- **SvcHost Split Threshold** — Adjusts SvcHostSplitThresholdInKB based on total system RAM to improve stability
- **Disable Game Bar** — Disables the Xbox Game Bar overlay and background services to prevent performance drops
- **Enable Game Mode** — Enables Windows Game Mode (recommended for Windows 11)
...
- **Disable Cortana & Search AI** — Disables Cortana, cloud search, web search integration, and related AI-powered search features
...
- **Visual Performance** — Sets Windows visual effects for best performance
- **Disable Notifications** — Disables notifications and the action center to minimize distractions
- **Optimize Mouse** — Reduces input lag and improves accuracy by disabling mouse acceleration
