...
> 새로운 언어 번역에 기여하고 싶으신가요? [CONTRIBUTING.md](./CONTRIBUTING.md)([日本語版](./CONTRIBUTING.ja-JP.md))를 참고해 주세요
...
버그 보고, 새로운 최적화, 문서 개선, 번역이 모두 환영합니다 [CONTRIBUTING.md](./CONTRIBUTING.md)([日本語版](./CONTRIBUTING.ja-JP.md))를 참고해 주세요
